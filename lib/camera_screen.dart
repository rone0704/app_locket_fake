...
class _CameraScreenState extends State<CameraScreen> {
  ...
  Future<void> _initCamera() async {
    try {
      ...
      print("Lỗi khi kết nối Firebase ở Camera: $e");
    }
  ...
  Future<void> _onNewCameraSelected(CameraDescription cameraDescription) async {
    ...
    } catch (e) { print('Error initializing camera: $e'); }
  ...
  void _toggleFlash() async {
    ...
    try { await _controller!.setFlashMode(newMode); setState(() => _flashMode = newMode); } catch (e) { print(e); }
  }

  Future<void> _takePicture() async {
    if (_isSimulatorMode) { setState(() => _capturedImage = XFile('')); return; }
    try { final image = await _controller!.takePicture(); setState(() => _capturedImage = image); } catch (e) { print(e); }
  }
