...
import 'profile_screen.dart'; // <--- MỚI: Để mở hồ sơ
import 'chat_list_screen.dart'; // <--- MỚI: Để mở hộp thư
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshotUser) {
        if (!snapshotUser.hasData) return const Scaffold(backgroundColor: Colors.black, body: Center(child: CircularProgressIndicator(color: Colors.amber)));
        ...
        return StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshotPosts) {
            if (snapshotPosts.connectionState == ConnectionState.waiting) return const Scaffold(backgroundColor: Colors.black, body: Center(child: CircularProgressIndicator(color: Colors.amber)));
            ...
            if (filteredPosts.isEmpty) return const Scaffold(backgroundColor: Colors.black, body: Center(child: Text("Chưa có khoảnh khắc nào", style: TextStyle(color: Colors.white54))));
